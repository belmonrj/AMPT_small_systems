...
set finalOutDir = "/phenix/plhf/dcm07e/dAuEnergyScan/sims/cumulants/pPb5020"

mv six.root $finalOutDir"/cumulants_ampt_ppb5020_"$nexodus"_"$nproc".root"
mv ppplane.root $finalOutDir"/pplane_ampt_ppb5020_"$nexodus"_"$nproc".root"

...
finalOutDir = "/phenix/plhf/belmonrj/AMPT_small_systems/output/dau62"
...
os.system("cp -r /phenix/hhj3/dcm07e/dAuEnergyScan/ampt_v2.26t5_dau62 {}".format(baseOutDir))
os.chdir(baseOutDir + "ampt_v2.26t5_dau62/")
os.getcwd()
...
shutil.copy2("six.root", "{}/cumulants_ampt_dau62_{}_{:04d}.root".format(finalOutDir, nexodus, nproc))
shutil.copy2("ppplane.root", "{}/pplane_ampt_dau62_{}_{:04d}.root".format(finalOutDir, nexodus, nproc))
shutil.copy2("out_EP.root", "{}/eplane_ampt_dau62_{}_{:04d}.root".format(finalOutDir, nexodus, nproc))
